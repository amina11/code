...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function model=mainfunction4_gradientclip(data, lambda_1, lambda_2, config)
tstart2=tic;

datasize=size(data.trainx,1);
earlystopingnum=round(datasize*0.2);
validation_x=data.trainx(1:earlystopingnum,:);
validation_y=data.trainy(1:earlystopingnum,:);
S=data.SS;
trainingdata=data.trainx(earlystopingnum+1:datasize,:);
traininglabel=data.trainy(earlystopingnum+1:datasize,:);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
startbig=tic;
data = [traininglabel, trainingdata];
data = data(randperm(size(data,1)),:);
y = data(:,1:outputDim);
X = data(:,outputDim+1:end);
